...
namespace ZXing
{
    ...
    public struct Colors
    {
        ...
        public static Color Transparent { get; } = Colors.FromArgb(0x00, 0xFF, 0xFF, 0xFF);
        public static Color Black { get; } = Colors.FromArgb(0xFF, 0x00, 0x00, 0x00);
        public static Color White { get; } = Colors.FromArgb(0xFF, 0xFF, 0xFF, 0xFF);
        public static Color Gray { get; } = Colors.FromArgb(0xFF, 0x80, 0x80, 0x80);
        public static Color Red { get; } = Colors.FromArgb(0xFF, 0xFF, 0x00, 0x00);
        public static Color Green { get; } = Colors.FromArgb(0xFF, 0x00, 0x80, 0x00);
        public static Color Blue { get; } = Colors.FromArgb(0xFF, 0x00, 0x00, 0xFF);
        public static Color Yellow { get; } = Colors.FromArgb(0xFF, 0xFF, 0xFF, 0x00);
        public static Color Purple { get; } = Colors.FromArgb(0xFF, 0x80, 0x00, 0x80);
        public static Color Teal { get; } = Colors.FromArgb(0xFF, 0x00, 0x80, 0x80);
        ...
        internal Colors(long value) => this.value = value;
        ...
        public Color GetColor()=> (Color) this.value;
        public static Color FromArgb(int argb) => new Colors(argb & 0xffffffff).GetColor();
        public static Color FromArgb(int red, int green, int blue) => Colors.FromArgb(255, red, green, blue);
        ...
        public static Color FromArgb(int alpha, int red, int green, int blue)
        {
            ...
            return new Colors(Colors.MakeArgb((byte)alpha, (byte)red, (byte)green, (byte)blue)).GetColor();
        }

        public static Color FromArgb(int alpha, Colors baseColor)
        {
            if (alpha < 0 || alpha > 255) throw new ArgumentOutOfRangeException(nameof(alpha));

            return new Colors(Colors.MakeArgb(unchecked((byte)alpha), baseColor.R, baseColor.G, baseColor.B)).GetColor();
        }
