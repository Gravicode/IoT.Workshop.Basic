...
namespace WS2812
{
    public class PixelController
    {
        ...
        public float T1H
        {
            get => onePulse.Duration0 * min_pulse;
            set => onePulse.Duration0 = (ushort)(value / min_pulse);
        }
        ...
        public void UpdatePixels()
        {
            ...
            transmitter.SendData(binaryCommandData,false);
        }
        ...
        public void Update()
        {
            ...
            transmitter.AddCommand(RETCommand);
            transmitter.Send(false);
        }
        ...
        private void ConfigureTransmitter()
        {
            ...
            transmitter.SourceClock = SourceClock.APB;
            transmitter.IdleLevel = false;
            transmitter.IsChannelIdle = true;
        }
