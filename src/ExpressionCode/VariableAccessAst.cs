...
// Type: ExpressionCode.VariableAccessAst
...
{
  internal class VariableAccessAst : ExpressionAst
  {
    public string variableName;

    public VariableAccessAst(Token token)
      : base(token)
    {
      this.NodeType = AstNodeType.VariableAccess;
      this.variableName = (string) token.value;
    }
  }
}
