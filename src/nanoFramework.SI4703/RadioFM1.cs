...
namespace nanoFramework.SI4703
{
	public class RadioFM1 
	{
		...
		public RadioFM1(int resetPin)
		{
			...
			this.resetPin = gpio.OpenPin(resetPin,PinMode.Output);
			this.resetPin.Write(PinValue.Low);
			//GTI.DigitalOutputFactory.Create(socket, Socket.Pin.Five, false, this);
			var setting = new I2cConnectionSettings(1, RadioFM1.I2C_ADDRESS, I2cBusSpeed.StandardMode);
			var device = new I2cDevice(setting);

			this.i2cBus = device; //new GTI.SoftwareI2CBus(socket, Socket.Pin.Eight, Socket.Pin.Nine, RadioFM1.I2C_ADDRESS, 100, this);
