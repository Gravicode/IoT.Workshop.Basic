...
namespace nanoFramework.ADXL345
{
    #region helper
    /// <summary>
    ...
    public class ADXL345
    {
        ...
        private int GetSingleRegister(byte register)
        {
            ...
            _adxl345.Write(new byte[] { register });
            _adxl345.Read(buffer);
        ...
        /// </summary>
        private readonly I2cDevice _adxl345;
        ...
        public byte DeviceID
        {
            get
            {
                var deviceID = (byte)GetSingleRegister(Registers.DeviceID);
                if (deviceID != 0xe5)
                {
        ...
        {
            get { return (sbyte)GetSingleRegister(Registers.OffsetX); }
            set { _adxl345.Write(new SpanByte(new byte[] { Registers.OffsetX, (byte)value })); }
        }
        ...
        {
            get { return (sbyte)GetSingleRegister(Registers.OffsetY); }
            set { _adxl345.Write(new SpanByte(new byte[] { Registers.OffsetY, (byte)value })); }
        }
        ...
        {
            get { return (sbyte)GetSingleRegister(Registers.OffsetZ); }
            set { _adxl345.Write(new SpanByte(new byte[] { Registers.OffsetZ, (byte)value })); }
        }
        ...
        public ADXL345(byte address = 0x53, I2cBusSpeed speed = I2cBusSpeed.StandardMode, ushort updateInterval = 100,
                       double accelerationChangeNotificationThreshold = 5.0F)
        {
            ...
            if ((speed != I2cBusSpeed.StandardMode) || (speed != I2cBusSpeed.FastMode))
            {
            ...
            var setting = new I2cConnectionSettings(1, address, speed);
        ...
        public void SetPowerState(bool linkActivityAndInactivity, bool autoASleep, bool measuring, bool sleep, Frequency frequency)
        {
            ...
            data |= (byte)frequency;
            _adxl345.Write(new SpanByte(new byte[] { Registers.PowerControl, data }));
        }
        ...
        public void SetDataFormat(bool selfTest, bool spiMode, bool fullResolution, bool justification, Range range)
        {
            ...
            data |= (byte)range;
            _adxl345.Write(new SpanByte(new byte[] { Registers.DataFormat, data }));
        }
        ...
        public void SetDataRate(byte dataRate, bool lowPower)
        {
            ...
            _adxl345.Write(new SpanByte(new byte[] { Registers.DataRate, data }));
        }
        ...
        {
            var data = new byte[6];
            _adxl345.WriteRead(new SpanByte(new byte[] { Registers.X0 }), new SpanByte(data));
        ...
        public void DisplayRegisters()
        {
            ...
            _adxl345.WriteRead(new SpanByte(new byte[] { Registers.TAPThreshold }), new SpanByte(registers));
            Debug.WriteLine(Registers.TAPThreshold+":"+registers.ToString());
