...
namespace nanoFramework.SIM900
{
	public class CellularRadio
	{
		...
		public CellularRadio(int powerPin,string ComPort)
		{
			...
			this.power = gpio.OpenPin(powerPin,PinMode.Output);
			this.power.Write(PinValue.Low);
			//GTI.DigitalOutputFactory.Create(socket, GT.Socket.Pin.Three, false, this);
			this.serial = new SerialPort(ComPort, 19200, Parity.None, 8, StopBits.One);
