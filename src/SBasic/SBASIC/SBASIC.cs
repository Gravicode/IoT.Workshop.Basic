...
namespace nanoFramework.Intepreter
{
    ...
    public class SBASIC
    {
        ...
        private void ProcScreen(string value)
        {
            ...
            try
            {
                OnBackColor(this, ColorUtility.ColorFromRGB(byte.Parse(pArr[0].Trim()), byte.Parse(pArr[1].Trim()), byte.Parse(pArr[2].Trim())));
            }
        ...
        private void ProcText(string value)
        {
            ...
            try
            {
                OnForeColor(this, ColorUtility.ColorFromRGB(byte.Parse(pArr[0].Trim()), byte.Parse(pArr[1].Trim()), byte.Parse(pArr[2].Trim())));
            }
