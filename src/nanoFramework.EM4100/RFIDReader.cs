...
namespace nanoFramework.EM4100
{
	public class RFIDReader
	{
		...
		public RFIDReader(string ComPort)
		{
			...
			this.port = new SerialPort(
				...
				8,
				StopBits.Two);
			//GTI.SerialFactory.Create(socket, 9600, GTI.SerialParity.None, GTI.SerialStopBits.Two, 8, GTI.HardwareFlowControl.NotRequired, this);
			this.port.ReadTimeout = 10;
			this.port.Open();

			this.timer = new GadgeteerTimer(100);
